...
[![github commit chart over time](https://github-commit-chart.herokuapp.com/chart${url})](https://github-commit-chart.herokuapp.com/chart${url})`;
</script>
...
<main>
  ...
  {#if url === '/'}
    <p>
      ...
      <a href="/riazXrazor/github-commit-chart">
